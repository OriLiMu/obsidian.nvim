...
describe("util.is_checkbox_task_line()", function()
  it("should identify markdown task checkbox lines", function()
    assert.is_true(util.is_checkbox_task_line "- [ ] todo")
    assert.is_true(util.is_checkbox_task_line "  - [x] done")
  end)

  it("should reject non-task lines", function()
    assert.is_false(util.is_checkbox_task_line "- item")
    assert.is_false(util.is_checkbox_task_line "- [ ]")
    assert.is_false(util.is_checkbox_task_line "random text")
  end)
end)
